...
- Workspace folder: `strummer.fun`
- Git repository: yes
- `package.json`: yes
- Detected stack: Vite, Tailwind, TypeScript, package "nuclear"
- Existing context-like files: README.md, readme.md, llms.txt, CONTRIBUTING.md
- Notable top-level files: .gitattributes, .gitignore, .node-version, .prettierignore, codecov.yml, CONTRIBUTING.md, crowdin.yml, eslint.config.ts, LICENSE, llms.txt, package.json, pnpm-lock.yaml
