...
DEFAULT_PORT = 9877
# Hardened for shared networks (co-living, coworking, hotels): the upstream
# default is "0.0.0.0", which binds every interface and exposes unauthenticated
# control of Live to anyone on the same wifi. The MCP server runs on this same
# machine, so loopback is all that is ever needed.
HOST = "127.0.0.1"
